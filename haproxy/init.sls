{%- set keyname = '/etc/ssl/private/rabbitmq' -%}
...
{{ keyname }}.pem:
  file.managed:
    - source: salt://rabbitmq/haproxy/files/cert.pem
    - replace: False
    - mode: 600
...
/etc/haproxy/haproxy.cfg:
  file.managed:
    - source: salt://rabbitmq/haproxy/files/haproxy.cfg
    - template: jinja
    - makedirs: True

/etc/default/haproxy:
  file.managed:
    - source: salt://rabbitmq/haproxy/files/default-haproxy
    - makedirs: True
